                    ...
                    {({ errors, handleBlur, handleChange, handleSubmit, touched, values }) => (
                        <form noValidate onSubmit={handleSubmit}>
                            <FormControl fullWidth error={Boolean(touched.name && errors.name)} sx={{ ...theme.typography.customInput }}>
                                <InputLabel htmlFor="outlined-adornment-email-register">Property Title</InputLabel>
                                <OutlinedInput
                            ...
                            >
                                <Grid item xs={12} md={4}>
                                    ...
                                    >
                                        <InputLabel htmlFor="outlined-adornment-email-register">$ Rent Amount</InputLabel>
                                        <OutlinedInput
                                            type="number"
                                            value={values.price}
                                            name="price"
                                ...
                                <Grid item xs={12} md={4}>
                                    <FormControl
                                        ...
                                        sx={{ ...theme.typography.customInput }}
                                    >
                                        <InputLabel htmlFor="outlined-adornment-email-register">No of Bed's</InputLabel>
                                        <OutlinedInput
                                            type="number"
                                            value={values.beds}
                                            name="beds"
                                ...
                                <Grid item xs={12} md={4}>
                                    <FormControl
                                        ...
                                        sx={{ ...theme.typography.customInput }}
                                    >
                                        <InputLabel htmlFor="outlined-adornment-email-register">No of Bath's</InputLabel>
                                        <OutlinedInput
                                            type="number"
                                            value={values.bath}
                                            name="bath"
                            ...
                            >
                                <Grid item xs={12} md={4}>
                                    <FormControl
                                        ...
                                        sx={{ ...theme.typography.customInput }}
                                    >
                                        <InputLabel htmlFor="outlined-adornment-email-register">SFT</InputLabel>
                                        <OutlinedInput
                                            type="number"
                                            value={values.sft}
                                            name="sft"
                                ...
                                <Grid item xs={12} md={4}>
                                    <Typography
                                        variant="subtitle1"
                                        color={Boolean(touched.propertyType && errors.propertyType) ? '#f44336' : ''}
                                    >
                                        Property Type
                                    </Typography>
                                ...
                                <Grid item xs={12} md={4}>
                                    <Typography variant="subtitle1" color={Boolean(touched.pets && errors.pets) ? '#f44336' : ''}>
                                        Pets
                                    </Typography>
                                    ...
                                    <FormControl
                                        ...
                                        sx={{ ...theme.typography.customInput }}
                                    >
                                        <Select value={values.pets} label="Pets" name="pets" onBlur={handleBlur} onChange={handleChange}>
                            ...
                            <FormControl
                                ...
                                sx={{ ...theme.typography.customInput }}
                            >
                                <InputLabel htmlFor="outlined-adornment-email-register">Location</InputLabel>
                                <OutlinedInput
                                    id="outlined-adornment-email-register"
                                    type="text"
                            ...
                            <FormControl
                                ...
                                sx={{ ...theme.typography.customInput }}
                            >
                                <InputLabel htmlFor="outlined-adornment-email-register">Link</InputLabel>
                                <OutlinedInput
                                    id="outlined-adornment-email-register"
                                    type="text"
                ...
                <Box sx={{ mt: 2 }}>
                  ...
                  >
                    {error}
                            ...
                            {loading ? <LinearProgress sx={{ my: 2 }} color="secondary" /> : null}
                            <Collapse in={updated}>
                                <Alert
                                    color="info"
                                    action={
                            ...
                            {!updated ? (
                                <Stack sx={{ mt: 2, justifyContent: 'center' }} spacing={3} direction="row">
                                    <Button
                                        // disabled
                                        fullWidth
                                        size="large"
